...
export const DEFAULT_FOLDER_BORDER: FolderBorderStyle = {
  enabled: true,
  color: "#74b9ff",
  opacity: 0.9,
  size: 4,
...
export function overlayTitleOnImage(
  ...
  folderBorder: FolderBorderStyle = DEFAULT_FOLDER_BORDER,
...
export function generateFavoriteIcon(): string {
...
export function generateSoundIcon(title: string, isPlaying: boolean = false): string {
...
export function generateEmptyIcon(): string {
