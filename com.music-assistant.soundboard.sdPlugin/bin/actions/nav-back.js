...
let NavBackAction = (() => {
    ...
    var NavBackAction = class extends _classSuper {
        ...
        async updateDisplay(actionId) {
            ...
            await action.setTitle(isEnabled ? "Back" : "Home");
        }
        generateBackIcon(enabled) {
            const color = enabled ? "#e17055" : "#636e72";
            const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="144" height="144" viewBox="0 0 144 144"><rect width="144" height="144" fill="#000000"/><path d="M95 72H49M49 72L72 49M49 72L72 95" stroke="${color}" stroke-width="8" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>`;
